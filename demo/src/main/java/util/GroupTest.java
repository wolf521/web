...
public class GroupTest {
    ...
    public static void main(String[] args) {
        ...
        list.add(new GroupTest().new Apple("红", 205));
        list.add(new GroupTest().new Apple("红", 11));
        list.add(new GroupTest().new Apple("绿", 48));
        list.add(new GroupTest().new Apple("绿", 53));
        list.add(new GroupTest().new Apple("黄", 19));
        list.add(new GroupTest().new Apple("黄", 24));
